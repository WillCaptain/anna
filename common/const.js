...
/**
 * 文本是正常的，还是斜体的
 * 【style，weight等文本特性适用于整体文本，文本中的个别选中可以有自己的格式，这些格式有innerhtml控制，不受anna管理】
 * 辉子
 */
 ...
 * 辉子
 */
export const EDITOR_NAME = 'anna-editor';
...
export const ANNA_NAME_SPACE = 'anna';
