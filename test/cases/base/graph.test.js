...
import {graph} from "../../../core/base/graph.js";
import {EVENT_TYPE} from "../../../common/const";
import {contextMenu} from "../../../core/contextToolbar/popupMenu";

// mock contextMenu
jest.mock('../../../core/contextToolbar/popupMenu', () => {
    const originalModule = jest.requireActual('../../../core/contextToolbar/popupMenu');
    return {
